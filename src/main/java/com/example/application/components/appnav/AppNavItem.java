...
public class AppNavItem extends Component {
    ...
    public AppNavItem(String label, Class<? extends Component> view, String parameter, String iconClass) {
        setPath(view, parameter);
        setLabel(label);
    ...
    public AppNavItem setPath(Class<? extends Component> view, String parameter) {
        String url = RouteConfiguration.forRegistry(getRouter().getRegistry()).getUrl(view, new RouteParameters(new RouteParam("subSectionId", parameter)));
        setPath(url);
        return this;
    }
